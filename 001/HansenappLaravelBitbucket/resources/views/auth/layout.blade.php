...
<head>
  <meta charset="UTF-8">
  <title>{{$titulo or 'Tela Login'}}</title>
  ...
  <!-- iCheck -->
  <link href="{{url('painel/plugins/iCheck/square/blue.css')}}" rel="stylesheet" type="text/css" />
    ...
    <!--[if lt IE 9]>
      ...
      <body class="login-page">
        ...
        <div class="login-box">
          ...
          <a href="/" title="Voltar ao site"><b>Hansen</b>App</a>
          </div><!-- /.login-logo -->
        ...
        <!-- iCheck -->
        <script src="{{url('painel/'plugins/iCheck/icheck.min.js" type="text/javascript"></script>
        <script>
          $(function () {
            $('input').iCheck({
